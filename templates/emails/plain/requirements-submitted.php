...
echo esc_html__( 'The customer has submitted their requirements for your order.', 'wp-sell-services' ) . "\n\n";
...
echo "\n\n";
printf( esc_html__( 'View requirements: %s', 'wp-sell-services' ), esc_url( wpss_get_order_url( $order->id ) ) );
echo "\n";
