...
do_action( 'wpss_email_content_before', 'withdrawal_requested', $vendor, $withdrawal_id );
?>
...
<?php
do_action( 'wpss_email_content_after', 'withdrawal_requested', $vendor, $withdrawal_id );
