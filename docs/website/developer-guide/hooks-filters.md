...
| `wpss_service_meta_saved` | `int $post_id, WP_Post $post` | `src/Admin/Metaboxes/ServiceMetabox.php:963` |
| `wpss_rest_service_created` | `int $service_id, WP_REST_Request $request` | `src/API/ServicesController.php:693` |
| `wpss_rest_service_updated` | `int $service_id, WP_REST_Request $request` | `src/API/ServicesController.php:813` |
| `wpss_rest_service_deleted` | `int $service_id, bool $force` | `src/API/ServicesController.php:862` |
...
| `wpss_service_pending_moderation` | `int $service_id` | `src/Frontend/ServiceWizard.php:1821` |
...
| `wpss_order_disputed` | `int $order_id, int $opened_by, string $reason` | `src/API/OrdersController.php:1119` |
...
| `wpss_stripe_refund_processed` | `string $payment_intent_id, object $charge` | `src/Integrations/Stripe/StripeGateway.php:1498` |
...
| `wpss_withdrawal_requested` | `int $withdrawal_id, int $vendor_id, float $amount` | `src/Services/EarningsService.php:737` |
| `wpss_withdrawal_processed` | `int $withdrawal_id, string $status, object $withdrawal` | `src/Services/EarningsService.php:530` |
| `wpss_auto_withdrawal_created` | `int $withdrawal_id, int $vendor_id, float $amount` | `src/Services/EarningsService.php:1340` |
...
| Filter | Parameters | File |
|--------|-----------|------|
| `wpss_service_meta_fields` | `array $fields, int $post_id` | `src/Admin/Metaboxes/ServiceMetabox.php:290` |
...
| Hook | Parameters | File |
|------|-----------|------|
| `wpss_service_wizard_saved` | `int $service_id, array $sanitized_data` | `src/Frontend/ServiceWizard.php:1809` |
...
| Filter | Parameters | File |
|--------|-----------|------|
| `wpss_vendor_can_create_service` | `bool $can_create, int $user_id` | `src/API/ServicesController.php:1113` |
...
| Filter | Parameters | File |
|--------|-----------|------|
| `wpss_add_service_to_cart` | `bool $added, array $cart_item, object $adapter` | `src/Frontend/AjaxHandlers.php:2367` |
...
| Filter | Parameters | File |
|--------|-----------|------|
| `wpss_email_from_name` | `string $from_name` | `src/Services/EmailService.php:2071` |
...
| `wpss_delivery_allowed_file_types` | `$allowed` | `src/functions/files.php:315` |
| `wpss_requirements_allowed_file_types` | `$allowed` | `src/functions/files.php:325` |
| `wpss_withdrawal_methods` | `$methods` | `src/API/EarningsController.php:657` |
...
| `wpss_rest_service_data` | `$data, $service, $request` | `src/API/ServicesController.php:1229` |
