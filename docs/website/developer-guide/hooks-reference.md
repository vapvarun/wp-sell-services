...
**515 hooks** across **724** firing sites.
...
| `wpss_after_order_view` | 1 | `templates/order/order-view.php:3669` | Hook: wpss_after_order_view |
...
| `wpss_after_status_change_notification` | 3 | `src/Services/OrderWorkflowManager.php:636` | Fires after status change processing. |
...
| `wpss_buyer_request_deleted` | 1 | `src/Services/BuyerRequestService.php:1071` | Fires when a buyer request is deleted. |
...
| `wpss_cancellation_requested` | 4 | `src/Services/OrderService.php:946` | Fires when a buyer requests order cancellation. |
...
| `wpss_cron_daily` | 0 | `src/Core/Plugin.php:2725` |  |
...
| `wpss_dispute_escalated` | 3 | `src/Services/DisputeWorkflowManager.php:311` | Fires when a dispute is escalated. |
| `wpss_dispute_evidence_added` | 2 | `src/Services/DisputeService.php:458` | Fires when evidence is added to a dispute. |
| `wpss_dispute_opened` | 4 | `src/Services/DisputeService.php:325` | Fires when a dispute is opened. |
| `wpss_dispute_resolved` | 4 | `src/Services/DisputeService.php:850` | Fires when a dispute is resolved. |
| `wpss_dispute_response_submitted` | 3 | `src/Services/DisputeWorkflowManager.php:184` | Fires when a dispute response is submitted. |
| `wpss_dispute_status_changed` | 3 | `src/Services/DisputeService.php:724` | Fires when dispute status changes. |
...
| `wpss_gateway_cards` | 1 | `src/Admin/Settings.php:1946` | Fires after core gateways, before Offline. |
...
| `wpss_gateway_settings_owned_by_rail` | 1 | `src/Admin/Settings.php:1908` | Fires instead of the gateway cards when a cart rail owns payment. |
...
| `wpss_milestone_approved` | 4 | `src/Services/MilestoneService.php:536` |  |
| `wpss_milestone_declined` | 3 | `src/Services/MilestoneService.php:710` |  |
| `wpss_milestone_paid` | 5 | `src/Services/MilestoneService.php:411` | Fires after a milestone payment has cleared and the vendor has been credited. Milestone is now in_progress. |
| `wpss_milestone_proposed` | 3 | `src/Services/BuyerRequestService.php:825` *(+1 more)* |  |
| `wpss_milestone_revision_requested` | 5 | `src/Services/MilestoneService.php:655` | Fires when a buyer sends a milestone phase back for changes. |
| `wpss_milestone_submitted` | 4 | `src/Services/MilestoneService.php:483` |  |
...
| `wpss_order_auto_refunded` | 3 | `src/Services/OrderWorkflowManager.php:1481` | Fires when an auto-refund is processed successfully. |
| `wpss_order_cancelled` | 2 | `src/Services/OrderWorkflowManager.php:752` | Fires when order is cancelled. |
| `wpss_order_completed` | 2 | `src/Services/OrderWorkflowManager.php:675` | Fires when order is completed. |
| `wpss_order_confirmation_details` | 1 | `templates/order/order-confirmation.php:250` | Hook: wpss_order_confirmation_details |
| `wpss_order_created` | 2 | `src/functions/orders.php:814` | Fires after a service order is created, on every e-commerce rail. |
...
| `wpss_order_partially_refunded` | 2 | `src/Services/OrderWorkflowManager.php:820` | Fires when an order is partially refunded. |
| `wpss_order_refund_processed` | 3 | `src/Services/OrderWorkflowManager.php:1400` | Fires after the gateway has processed a refund, with its raw result. |
| `wpss_order_refunded` | 2 | `src/Services/OrderWorkflowManager.php:787` | Fires when an order is refunded. |
| `wpss_order_requirements_submitted` | 2 | `src/API/OrdersController.php:1165` |  |
| `wpss_order_started` | 1 | `src/API/OrdersController.php:792` |  |
| `wpss_order_status_changed` | 3 | `src/Admin/Pages/ManualOrderPage.php:779` *(+5 more)* |  |
| `wpss_order_status_pending_requirements` | 2 | `src/Integrations/Standalone/StandaloneOrderProvider.php:407` |  |
| `wpss_order_view_actions` | 1 | `templates/order/order-view.php:444` | Hook: wpss_order_view_actions |
| `wpss_order_view_details` | 1 | `templates/order/order-view.php:767` | Hook: wpss_order_view_details |
| `wpss_order_view_header` | 1 | `templates/order/order-view.php:235` | Hook: wpss_order_view_header |
| `wpss_order_view_sidebar` | 1 | `templates/order/order-view.php:1607` | Hook: wpss_order_view_sidebar |
...
| `wpss_proposal_accepted` | 3 | `src/Services/BuyerRequestService.php:853` | Fires when a proposal is accepted via order conversion. |
...
| `wpss_proposal_status_updated` | 2 | `src/Services/BuyerRequestService.php:833` *(+1 more)* |  |
...
| `wpss_request_converted_to_order` | 5 | `src/Services/BuyerRequestService.php:911` | Fires when a buyer request is converted to an order. |
...
| `wpss_requirements_timeout` | 2 | `src/Services/OrderWorkflowManager.php:536` | Fires when a requirements timeout action is taken. |
...
| `wpss_send_requirements_reminder_email` | 3 | `src/Services/OrderWorkflowManager.php:402` |  |
...
| `wpss_settings_sections_gateways` | 0 | `src/Admin/Settings.php:1956` | Unified gateway sections hook. |
| `wpss_settings_sections_payments` | 1 | `src/Admin/Settings.php:1800` | Legacy payments-sections hook. |
| `wpss_settings_tab_` | 0 | `src/Admin/Settings.php:1681` | Fires when rendering a custom settings tab added by Pro or extensions. |
...
| `wpss_updated` | 2 | `src/Core/Plugin.php:437` | Fires after the plugin has been installed or upgraded. |
...
| `wpss_vendor_contacted` | 5 | `src/Frontend/AjaxHandlers.php:2315` | Fires after a vendor contact message is sent. |
...
| `wpss_vendor_level_promoted` | 3 | `src/Services/OrderWorkflowManager.php:607` | Fires when a vendor is promoted to a higher level. |
...
| `wpss_vendor_profile_saved` | 2 | `src/Frontend/AjaxHandlers.php:3704` *(+1 more)* | Fires after a vendor profile is saved from a frontend form. |
...
| `wpss_add_service_to_cart` | 3 | `src/Frontend/AjaxHandlers.php:2501` | Filter to let e-commerce adapters handle cart addition natively. |
...
| `wpss_allow_late_requirements_submission` | 1 | `src/functions/orders.php:494` *(+1 more)* | Filter whether late requirements submission is allowed. |
| `wpss_analytics_widgets` | 1 | `src/Core/Plugin.php:2423` *(+1 more)* | Filter the registered analytics widgets. |
| `wpss_api_controllers` | 1 | `src/API/API.php:184` | Filter registered API controllers. |
| `wpss_api_cors_origins` | 0 | `src/API/API.php:1365` | Filter allowed CORS origins. |
| `wpss_api_public_settings` | 1 | `src/API/API.php:648` | Filter public API settings. |
| `wpss_app_abuse_contact` | 1 | `src/API/API.php:788` |  |
| `wpss_app_branding` | 1 | `src/API/API.php:773` | Public subset only. Pro's white label supplies the real values. |
| `wpss_app_enabled` | 1 | `src/API/API.php:770` |  |
| `wpss_app_features` | 1 | `src/API/API.php:796` |  |
| `wpss_app_min_version` | 1 | `src/API/API.php:764` |  |
...
| `wpss_batch_max_requests` | 1 | `src/API/API.php:1292` | Handle batch requests for mobile efficiency. |
...
| `wpss_checkout_badges` | 2 | `src/functions/payments.php:194` | Filter the checkout reassurance badges. |
...
| `wpss_checkout_tax_rate` | 3 | `src/functions/money.php:465` |  |
...
| `wpss_currencies` | 1 | `src/functions/money.php:1553` | Filter supported currencies. |
| `wpss_currency` | 1 | `src/functions/money.php:696` | Filter the default currency. |
| `wpss_currency_decimals` | 2 | `src/functions/money.php:166` | Filter the number of decimal places for a currency. |
| `wpss_currency_format` | 3 | `src/functions/money.php:758` | Filter the currency format string. |
| `wpss_currency_registry` | 1 | `src/functions/money.php:1532` | Filter the canonical currency registry. |
| `wpss_currency_symbols` | 1 | `src/functions/money.php:731` | Filter currency symbols. |
...
| `wpss_ecommerce_platform_description` | 1 | `src/Admin/Settings.php:3303` | Filter the platform field description. |
...
| `wpss_email_providers` | 1 | `src/Core/Plugin.php:2411` | Filter the registered email providers. |
...
| `wpss_notification_types` | 1 | `src/Admin/Settings.php:3818` | Filter the switchable notification types. |
...
| `wpss_order_actions` | 2 | `templates/order/order-view.php:429` | Filter: wpss_order_actions |
...
| `wpss_order_payment_reference` | 2 | `src/functions/orders.php:906` | Filter the payment-rail receipt reference shown on an order. |
| `wpss_order_status_groups` | 1 | `src/functions/orders.php:581` | Filter the order status groups used by the dashboard filter chips. |
| `wpss_order_status_label` | 3 | `templates/order/order-view.php:168` | Filter: wpss_order_status_label |
| `wpss_order_status_transitions` | 3 | `src/Services/OrderService.php:637` | Filter allowed status transitions. |
...
| `wpss_payment_gateways` | 1 | `src/Core/Plugin.php:2368` *(+4 more)* | Filter the registered payment gateways. |
...
| `wpss_pre_open_dispute` | 2 | `src/Services/DisputeService.php:276` | Filter dispute data before saving to the database. |
| `wpss_pre_order_status_change` | 4 | `src/Services/OrderService.php:382` | Filter whether an order status change should proceed. |
| `wpss_pre_process_gateway_refund` | 4 | `src/Services/OrderWorkflowManager.php:1348` | Short-circuit the gateway refund. |
...
| `wpss_proposal_order_revisions` | 3 | `src/Services/BuyerRequestService.php:741` |  |
| `wpss_rail_status_map` | 2 | `src/functions/orders.php:1328` | Filters the rail status map. |
...
| `wpss_service_order_slug` | 1 | `src/Core/Plugin.php:592` *(+3 more)* | Filter the service order URL slug. |
...
| `wpss_settings_currencies` | 1 | `src/Admin/Settings.php:3780` | Filter the currencies available in the Settings currency dropdown. |
...
| `wpss_should_reverse_vendor_earnings` | 2 | `src/Services/OrderWorkflowManager.php:1090` | Filters whether the vendor's wallet earnings should be reversed. |
...
| `wpss_storage_providers` | 1 | `src/Core/Plugin.php:2399` *(+3 more)* | Filter the registered storage providers. |
...
| `wpss_terms_page_slugs` | 1 | `src/Core/Activator.php:503` | Filters the slugs searched when auto-mapping an existing terms page. |
| `wpss_three_decimal_currencies` | 1 | `src/functions/money.php:568` | Filter the list of three-decimal currency codes. |
| `wpss_tip_commission_rate` | 3 | `src/Services/TippingService.php:372` | Filter the commission rate applied to a tip. |
| `wpss_tip_quick_amounts` | 2 | `templates/order/order-view.php:2249` |  |
...
| `wpss_vendor_slug` | 1 | `src/Core/Plugin.php:584` *(+1 more)* | Filter the vendor profile URL slug. |
...
| `wpss_wallet_manager` | 1 | `src/functions/money.php:1575` | Filter the wallet manager instance. |
| `wpss_wallet_providers` | 1 | `src/Core/Plugin.php:2387` *(+2 more)* | Filter the registered wallet providers. |
...
| `wpss_zero_decimal_currencies` | 1 | `src/functions/money.php:657` | Filter the list of zero-decimal currency codes. |
