...
For tips on creating a great gallery, see [Service Media](service-media.md).
...
For more details, see [Requirements and FAQs](service-requirements-faqs.md).
...
For more on pricing and types, see [Service Add-ons](service-addons.md).
...
- **[Pricing and Packages](pricing-packages.md)** -- How to structure your 3-tier pricing
- **[Service Add-ons](service-addons.md)** -- Extra services and upgrades
- **[Service Media](service-media.md)** -- Images and videos best practices
- **[Requirements and FAQs](service-requirements-faqs.md)** -- Collecting buyer information
- **[Publishing and Moderation](publishing-moderation.md)** -- What happens after you hit Publish
