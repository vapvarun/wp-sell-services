...
// Load autoloader for SchemaManager.
...
$post_types = [ 'wpss_service', 'wpss_request' ];
...
$taxonomies = [ 'wpss_service_category', 'wpss_service_tag' ];
...
$roles = [ 'administrator', 'shop_manager', 'author', 'editor' ];
