<?php
/**
 * Withdrawal Approved Email (HTML)
 *
 * Sent when admin approves a vendor's withdrawal request.
 *
 ...
 * @var string  $admin_note     Admin note (optional).
...
do_action( 'wpss_email_content_before', 'withdrawal_approved', $recipient );
?>
...
<p style="margin: 0 0 20px 0; font-size: 16px; color: #3c3c3c; line-height: 1.6;">
	...
	printf(
		...
		esc_html__( 'Your withdrawal request for %s has been approved and is being processed.', 'wp-sell-services' ),
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; background-color: #f9f9f9; border-radius: 4px;">
	<tbody>
		<tr>
			...
			<td style="padding: 12px; border-bottom: 1px solid #e5e5e5; font-weight: 600; color: #28a745;"><?php echo esc_html( $amount ); ?></td>
		</tr>
		<tr>
...
<div style="background: #d4edda; padding: 16px; border-radius: 4px; margin: 20px 0;">
	<strong style="color: #155724;"><?php esc_html_e( 'Note:', 'wp-sell-services' ); ?></strong>
	<p style="margin: 8px 0 0; color: #155724;"><?php echo esc_html( $admin_note ); ?></p>
</div>
<?php endif; ?>
...
<?php
do_action( 'wpss_email_content_after', 'withdrawal_approved', $recipient );
