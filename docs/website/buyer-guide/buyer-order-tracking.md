...
**What to do:** Provide clear evidence supporting your position -- screenshots, messages, the original requirements, and the delivery. The admin will review everything and make a decision. See [Opening a Dispute](../disputes-resolution/opening-a-dispute.md) for details.
...
- [Buyer Dashboard](buyer-dashboard.md) -- Navigate all dashboard sections
- [How Orders Work](../order-management/order-lifecycle.md) -- The complete order lifecycle
- [Deliveries & Revisions](../order-management/deliveries-revisions.md) -- How delivery and revision cycles work
- [Opening a Dispute](../disputes-resolution/opening-a-dispute.md) -- When and how to dispute
- [Tips for Getting Great Results](buyer-tips-best-practices.md) -- Best practices for a smooth order
