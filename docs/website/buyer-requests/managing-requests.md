...
**Can I accept multiple proposals from one request?**
No. Only one proposal can be accepted per request. If you need multiple vendors, post separate requests.

**What if no proposals come in?**
Try increasing your budget, improving your description, or checking that the category is correct. Give it 3-5 days before making changes.

**Can I reopen an expired request?**
You can repost it with updated details. The original expired request remains in your history for reference.
