...
| `wpss_service_pending_moderation` | `int $service_id` | `src/Frontend/ServiceWizard.php:1881` |
...
| `wpss_order_completed` | `int $order_id, object $order` | `src/Services/OrderWorkflowManager.php:765` |
| `wpss_order_cancelled` | `int $order_id, int $user_id, string $reason` | `src/Services/OrderWorkflowManager.php:856` |
...
| `wpss_after_status_change_notification` | `int $order_id, string $new_status, string $old_status` | `src/Services/OrderWorkflowManager.php:726` |
| `wpss_send_requirements_reminder_email` | `int $order_id, int $reminder_num, string $message` | `src/Services/OrderWorkflowManager.php:491` |
| `wpss_requirements_timeout` | `int $order_id, bool $auto_start` | `src/Services/OrderWorkflowManager.php:626` |
...
| `wpss_order_auto_refunded` | `int $order_id, object $order, mixed $refund_result` | `src/Services/OrderWorkflowManager.php:1612` |
...
| Hook | Parameters | File |
|------|-----------|------|
| `wpss_offline_multi_orders_created` | `array $order_ids, int $customer_id` | `src/Integrations/Gateways/OfflineGateway.php:739` |
| `wpss_offline_order_created` | `int $order_id, object $order` | `src/Integrations/Gateways/OfflineGateway.php:663` |
| `wpss_offline_order_paid` | `int $order_id, string $transaction_id` | `src/Integrations/Gateways/OfflineGateway.php:923` |
...
| `wpss_after_cascade_delete_service` | `int $service_id` | `src/Services/DataCascadeHandler.php:135` |
| `wpss_before_cascade_delete_request` | `int $request_id` | `src/Services/DataCascadeHandler.php:151` |
| `wpss_after_cascade_delete_request` | `int $request_id` | `src/Services/DataCascadeHandler.php:162` |
| `wpss_before_cascade_delete_user` | `int $user_id` | `src/Services/DataCascadeHandler.php:178` |
...
| `wpss_vendor_level_promoted` | `int $user_id, string $new_level, string $current_level` | `src/Services/OrderWorkflowManager.php:697` |
...
| Hook | Parameters | File |
|------|-----------|------|
| `wpss_dispute_opened` | `int $dispute_id, int $order_id, int $opened_by, array $data` | `src/Services/DisputeService.php:404` |
| `wpss_dispute_evidence_added` | `int $dispute_id, int $user_id` | `src/Services/DisputeService.php:543` |
| `wpss_dispute_status_changed` | `int $dispute_id, string $status, string $old_status` | `src/Services/DisputeService.php:839` |
| `wpss_dispute_resolved` | `int $dispute_id, string $resolution, object $dispute, float $refund_amount` | `src/Services/DisputeService.php:990` |
...
| `wpss_buyer_request_status_changed` | `int $request_id, string $status, string $old_status` | `src/Services/BuyerRequestService.php:488` |
| `wpss_request_converted_to_order` | `int $order_id, int $request_id, int $proposal_id, object $request, object $proposal` | `src/Services/BuyerRequestService.php:1025` |
...
| `wpss_proposal_accepted` | `int $proposal_id, object $proposal, object $request` | `src/Services/BuyerRequestService.php:967` |
...
| `wpss_buyer_request_deleted` | `int $request_id` | `src/Services/BuyerRequestService.php:1185` |
...
| Hook | Parameters | File |
|------|-----------|------|
| `wpss_service_wizard_saved` | `int $service_id, array $sanitized_data` | `src/Frontend/ServiceWizard.php:1869` |
...
| Hook | Parameters | File |
|------|-----------|------|
| `wpss_dashboard_section_before_content` | `string $section, int $user_id` | `src/Frontend/UnifiedDashboard.php:914` |
...
| Filter | Parameters | File |
|--------|-----------|------|
| `wpss_add_service_to_cart` | `bool $added, array $cart_item, object $adapter` | `src/Frontend/AjaxHandlers.php:2332` |
...
| `wpss_dashboard_section_template` | `$template_path, $section` | `src/Frontend/UnifiedDashboard.php:889` |
...
| `wpss_related_services_args` | `$args, $service` | `src/Frontend/SingleServiceView.php:791` |
...
| `wpss_can_access_dashboard_section` | `$allowed, $section, $user_id` | `src/Frontend/UnifiedDashboard.php:437` |
| `wpss_dashboard_sections` | `$sections, $user_id, $is_vendor` | `src/Frontend/UnifiedDashboard.php:536` |
| `wpss_dashboard_section_titles` | `$titles` | `src/Frontend/UnifiedDashboard.php:838` |
...
| `wpss_edd_thankyou_redirect` | `$redirect, $order_id` | `EDDCheckoutProvider.php:251` |
