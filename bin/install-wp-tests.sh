...
if [[ $WP_VERSION =~ ^[0-9]+\.[0-9]+\-(beta|RC)[0-9]+$ ]]; then
	...
	# http serves a hierarchical list of all combos
...
install_wp() {
	...
	download https://raw.github.com/marber/phpunit-selenium/WPSE-patched/PHPUnit/Extensions/Selenium2TestCase.php $WP_CORE_DIR/wp-content/plugins/Selenium2TestCase.php
}

install_test_suite() {
	# portable in-place argument for both GNU sed and Mac OS DMG sed
