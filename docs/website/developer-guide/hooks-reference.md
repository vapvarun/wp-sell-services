...
| `wpss_order_created` | 2 | `src/functions/orders.php:899` | Fires after a service order is created, on every e-commerce rail. |
...
| `wpss_order_payment_reference` | 2 | `src/functions/orders.php:991` | Filter the payment-rail receipt reference shown on an order. |
...
| `wpss_rail_status_map` | 2 | `src/functions/orders.php:1413` | Filters the rail status map. |
