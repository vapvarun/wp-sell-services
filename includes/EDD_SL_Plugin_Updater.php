<?php
/**
 * EDD Software Licensing — Plugin Updater (drop-in)
 *
 * Vendored 3rd-party file from {@link https://github.com/WebDevStudios/EDD_SL_Plugin_Updater}
 * v1.9.4 (2025-01-29). DO NOT modify locally — when upgrading, replace the
 * whole file with the latest upstream release so future updates stay clean.
 *
 * The file uses the 'easy-digital-downloads' textdomain (upstream convention)
 * and has its own escaping conventions; PCP/WPCS rules are suppressed for the
 * whole file so we don't drift from upstream while satisfying our linter.
 *
