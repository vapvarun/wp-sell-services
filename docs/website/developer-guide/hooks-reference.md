...
**480 hooks** across **679** firing sites.
...
| `wpss_cron_daily` | 0 | `src/Core/Plugin.php:2864` |  |
| `wpss_dashboard_header` | 0 | `src/Frontend/UnifiedDashboard.php:719` | Fires at the start of the unified dashboard header. |
...
| `wpss_order_status_changed` | 3 | `src/Admin/Pages/ManualOrderPage.php:767` *(+3 more)* |  |
...
| `wpss_render_secret_field` | 1 | `src/Admin/Settings.php:237` *(+2 more)* |  |
...
| `wpss_analytics_widgets` | 1 | `src/Core/Plugin.php:2558` | Filter the registered analytics widgets. |
...
| `wpss_email_providers` | 1 | `src/Core/Plugin.php:2546` | Filter the registered email providers. |
...
| `wpss_max_order_quantity` | 2 | `src/Frontend/SingleServiceView.php:926` | Filters the maximum order quantity for a service. |
...
| `wpss_payment_gateways` | 1 | `src/Core/Plugin.php:2503` *(+2 more)* | Filter the registered payment gateways. |
...
| `wpss_storage_providers` | 1 | `src/Core/Plugin.php:2534` *(+2 more)* | Filter the registered storage providers. |
...
| `wpss_wallet_providers` | 1 | `src/Core/Plugin.php:2522` *(+1 more)* | Filter the registered wallet providers. |
