...
| `wpss_order_completed` | `int $order_id, object $order` | `src/Services/OrderWorkflowManager.php:638` |
| `wpss_order_cancelled` | `int $order_id, int $user_id, string $reason` | `src/Services/OrderWorkflowManager.php:715` |
...
| `wpss_after_status_change_notification` | `int $order_id, string $new_status, string $old_status` | `src/Services/OrderWorkflowManager.php:599` |
...
| `wpss_requirements_timeout` | `int $order_id, bool $auto_start` | `src/Services/OrderWorkflowManager.php:499` |
...
| `wpss_order_auto_refunded` | `int $order_id, object $order, mixed $refund_result` | `src/Services/OrderWorkflowManager.php:1233` |
...
| `wpss_checkout_tax_rate` | `float $tax_rate, int $vendor_id, int $service_id` | `src/functions/money.php:442` |
...
| `wpss_vendor_level_promoted` | `int $user_id, string $new_level, string $current_level` | `src/Services/OrderWorkflowManager.php:570` |
...
| `wpss_currency` | `$currency` | `src/functions/money.php:672` |
...
| `wpss_currency_symbols` | `$symbols` | `src/functions/money.php:707` |
| `wpss_currency_format` | `$format, $symbol, $currency` | `src/functions/money.php:734` |
| `wpss_currencies` | `$currencies` | `src/functions/money.php:1529` |
...
| `wpss_wallet_manager` | `null` | `src/functions/money.php:1551` |
...
| Filter | Parameters | File |
|--------|-----------|------|
| `wpss_currency_registry` | `array<string, array{name:string, symbol:string, decimals:int}> $registry` | `src/functions/money.php:1508` |
| `wpss_currency_decimals` | `int $decimals, string $currency` | `src/functions/money.php:185` |
| `wpss_zero_decimal_currencies` | `string[] $codes` | `src/functions/money.php:634` |
...
| `wpss_batch_max_requests` | `$max` (default 25) | `src/API/API.php:1292` |
| `wpss_api_cors_origins` | `$origins` | `src/API/API.php:1365` |
