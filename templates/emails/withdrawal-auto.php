...
<p style="margin: 0 0 20px 0; font-size: 16px; color: #3c3c3c; line-height: 1.6;">
	<?php esc_html_e( 'An automatic withdrawal has been created based on a vendor\'s payout schedule.', 'wp-sell-services' ); ?>
</p>
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; background-color: #f9f9f9; border-radius: 4px;">
	<tbody>
		...
		<tr>
			<th style="padding: 12px; text-align: left; font-weight: 600;"><?php esc_html_e( 'Amount', 'wp-sell-services' ); ?></th>
