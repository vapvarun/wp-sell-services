<?php
/**
 * Order Cancelled email (sent to both parties)
 *
...
<p><?php esc_html_e( 'We regret to inform you that the following order has been cancelled:', 'wp-sell-services' ); ?></p>
...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; margin-bottom: 20px;" border="1">
	<tbody>
		...
		<tr>
			...
			<td class="td" style="text-align:left;color:#dc3545;"><strong><?php esc_html_e( 'Cancelled', 'wp-sell-services' ); ?></strong></td>
		</tr>
	</tbody>
</table>

<p><?php esc_html_e( 'If you believe this was done in error or have any questions, please contact support.', 'wp-sell-services' ); ?></p>
