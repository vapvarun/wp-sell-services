...
**517 hooks** across **730** firing sites.
...
| `wpss_app_sessions_revoked` | 2 | `src/functions/misc.php:423` | Fires after a member's app sessions have been revoked. |
| `wpss_auto_withdrawal_created` | 3 | `src/Services/EarningsService.php:1300` | Fires when auto withdrawal is created. |
...
| `wpss_cron_daily` | 0 | `src/Core/Plugin.php:2724` |  |
...
| `wpss_dispute_evidence_added` | 2 | `src/Services/DisputeService.php:455` | Fires when evidence is added to a dispute. |
| `wpss_dispute_opened` | 4 | `src/Services/DisputeService.php:322` | Fires when a dispute is opened. |
| `wpss_dispute_resolved` | 4 | `src/Services/DisputeService.php:847` | Fires when a dispute is resolved. |
| `wpss_dispute_response_submitted` | 3 | `src/Services/DisputeWorkflowManager.php:184` | Fires when a dispute response is submitted. |
| `wpss_dispute_status_changed` | 3 | `src/Services/DisputeService.php:721` | Fires when dispute status changes. |
...
| `wpss_order_auto_refunded` | 3 | `src/Services/OrderWorkflowManager.php:1479` | Fires when an auto-refund is processed successfully. |
...
| `wpss_order_refund_processed` | 3 | `src/Services/OrderWorkflowManager.php:1398` | Fires after the gateway has processed a refund, with its raw result. |
...
| `wpss_updated` | 2 | `src/Core/Plugin.php:438` | Fires after the plugin has been installed or upgraded. |
...
| `wpss_vendor_contacted` | 5 | `src/Frontend/AjaxHandlers.php:2314` | Fires after a vendor contact message is sent. |
...
| `wpss_vendor_profile_saved` | 2 | `src/Frontend/AjaxHandlers.php:3702` *(+1 more)* | Fires after a vendor profile is saved from a frontend form. |
...
| `wpss_analytics_widgets` | 1 | `src/Core/Plugin.php:2422` *(+1 more)* | Filter the registered analytics widgets. |
...
| `wpss_app_token_lifetime` | 1 | `src/functions/misc.php:464` | Filter how long a mobile app token stays valid. |
...
| `wpss_checkout_tax_rate` | 3 | `src/functions/money.php:485` |  |
...
| `wpss_currencies` | 1 | `src/functions/money.php:1572` | Filter supported currencies. |
| `wpss_currency` | 1 | `src/functions/money.php:715` | Filter the default currency. |
...
| `wpss_email_providers` | 1 | `src/Core/Plugin.php:2410` | Filter the registered email providers. |
...
| `wpss_payment_gateways` | 1 | `src/Core/Plugin.php:2367` *(+4 more)* | Filter the registered payment gateways. |
...
| `wpss_pre_process_gateway_refund` | 4 | `src/Services/OrderWorkflowManager.php:1346` | Short-circuit the gateway refund. |
...
| `wpss_rest_order_data` | 3 | `src/API/OrdersController.php:2014` | Filters the order data returned in REST API responses. |
...
| `wpss_service_order_slug` | 1 | `src/Core/Plugin.php:593` *(+3 more)* | Filter the service order URL slug. |
...
| `wpss_storage_providers` | 1 | `src/Core/Plugin.php:2398` *(+3 more)* | Filter the registered storage providers. |
...
| `wpss_three_decimal_currencies` | 1 | `src/functions/money.php:588` | Filter the list of three-decimal currency codes. |
...
| `wpss_wallet_providers` | 1 | `src/Core/Plugin.php:2386` *(+2 more)* | Filter the registered wallet providers. |
...
| `wpss_zero_decimal_currencies` | 1 | `src/functions/money.php:677` | Filter the list of zero-decimal currency codes. |
