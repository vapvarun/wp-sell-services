...
| Hook | Parameters | File |
|------|-----------|------|
| `wpss_dashboard_section_before_content` | `string $section, int $user_id` | `src/Frontend/UnifiedDashboard.php:917` |
...
| `wpss_dashboard_section_template` | `$template_path, $section` | `src/Frontend/UnifiedDashboard.php:892` |
...
| `wpss_withdrawal_methods` | `$methods` | `src/API/EarningsController.php:702` |
...
| `wpss_can_access_dashboard_section` | `$allowed, $section, $user_id` | `src/Frontend/UnifiedDashboard.php:440` |
| `wpss_dashboard_sections` | `$sections, $user_id, $is_vendor` | `src/Frontend/UnifiedDashboard.php:539` |
| `wpss_dashboard_section_titles` | `$titles` | `src/Frontend/UnifiedDashboard.php:841` |
