...
class VendorsController extends RestController {
	...
	public function register_routes(): void {
		...
		register_rest_route(
			...
			[
				[
					'methods'             => WP_REST_Server::READABLE,
					'callback'            => [ $this, 'get_current_vendor' ],
					'permission_callback' => [ $this, 'check_permissions' ],
				],
				[
					'methods'             => WP_REST_Server::EDITABLE,
					'callback'            => [ $this, 'update_current_vendor' ],
					'permission_callback' => [ $this, 'check_permissions' ],
		...
		register_rest_route(
			...
			[
				[
					'methods'             => WP_REST_Server::READABLE,
					'callback'            => [ $this, 'get_vendor_services' ],
					'permission_callback' => '__return_true',
					'args'                => [
						'page' => [
							'default' => 1,
	...
	public function prepare_item_for_response( $vendor, $request, bool $is_self = false ): WP_REST_Response {
		...
		$data = [
			...
			'avatar'         => get_avatar_url( $vendor_id, [ 'size' => 96 ] ),
			'avatar_large'   => get_avatar_url( $vendor_id, [ 'size' => 256 ] ),
	...
	private function prepare_service_for_response( \WP_Post $post ): array {
		...
		return [
			...
			'category'       => wp_get_post_terms( $service_id, 'wpss_service_category', [ 'fields' => 'names' ] )[0] ?? '',
		];
	}
